...
import mean_std_vari

class UnitTests(unittest.TestCase):
    def test_calculate(self):
        actual = mean_std_vari.calculate([2,6,2,8,4,0,1,5,7])
        ...
        'max': [[8, 6, 7], [6, 8, 7], 8], 'min': [[1, 4, 0], [2, 0, 1], 0], 
    ...
    def test_calculate2(self):
        actual = mean_std_vari.calculate([9,1,5,3,3,3,2,9,0])
    ...
    def test_calculate_with_few_digits(self):
        self.assertRaisesRegex(ValueError, "List must contain nine numbers.", mean_std_vari.calculate, [2,6,2,8,4,0,1,])
